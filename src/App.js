            ...
            <div className="skillsGridCards">
              <div className="card skillCard">
                ...
                <div className="skillList">
                  <div className="skillItem"><span className="skillTag">🐍 Python</span><div className="skillLevel"><div className="skillLevelFill" style={{width: '92%'}}/></div></div>
                  <div className="skillItem"><span className="skillTag">🔢 NumPy</span><div className="skillLevel"><div className="skillLevelFill" style={{width: '75%'}}/></div></div>
                  ...
                  <div className="skillItem"><span className="skillTag">📊 PySpark</span><div className="skillLevel"><div className="skillLevelFill" style={{width: '88%'}}/></div></div>
                </div>
              </div>
              ...
              <div className="card skillCard">
                ...
                <div className="skillList">
                  ...
                  <div className="skillItem"><span className="skillTag">⚡ FastAPI</span><div className="skillLevel"><div className="skillLevelFill" style={{width: '88%'}}/></div></div>
                  <div className="skillItem"><span className="skillTag">🟣 C# / .NET</span><div className="skillLevel"><div className="skillLevelFill" style={{width: '88%'}}/></div></div>
              ...
              <div className="card skillCard">
                ...
                <div className="skillList">
                  ...
                  <div className="skillItem"><span className="skillTag">🔤 NLP</span><div className="skillLevel"><div className="skillLevelFill" style={{width: '68%'}}/></div></div>
                </div>
              </div>
            </div>
          </div>
